      ...
      <div className='flex h-[90vh] pt-20 items-center '>
        ...
        <div className=' w-[50%] flex justify-evenly flex-col items-center'>
          <form className='flex justify-evenly h-[70vh] w-[50%] flex-col bg-white  '>
            ...
            <input className='bg-transparent p-2  outline-none border-b border-gray-500 ' placeholder='Name ' type="text" />
            ...
            <button className=' bg-red-400 p-4 rounded-2xl text-white'> Create Account</button>
